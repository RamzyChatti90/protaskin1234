...
import static com.protaskin1234.domain.CategoryAsserts.*;
import static com.protaskin1234.web.rest.TestUtil.createUpdateProxyForBean;
...
import com.protaskin1234.IntegrationTest;
import com.protaskin1234.domain.Category;
import com.protaskin1234.repository.CategoryRepository;
...
class CategoryResourceIT {
    ...
    public static Category createEntity() {
        return new Category().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).createdAt(DEFAULT_CREATED_AT);
    }
    ...
    public static Category createUpdatedEntity() {
        return new Category().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).createdAt(UPDATED_CREATED_AT);
    }
    ...
    void putExistingCategory() throws Exception {
        ...
        updatedCategory.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).createdAt(UPDATED_CREATED_AT);
    ...
    void partialUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.name(UPDATED_NAME).createdAt(UPDATED_CREATED_AT);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).createdAt(UPDATED_CREATED_AT);

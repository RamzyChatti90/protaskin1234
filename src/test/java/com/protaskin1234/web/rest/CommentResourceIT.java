...
import static com.protaskin1234.domain.CommentAsserts.*;
...
import com.protaskin1234.repository.CommentRepository;
...
class CommentResourceIT {
    ...
    public static Comment createEntity() {
        return new Comment().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).createdAt(DEFAULT_CREATED_AT);
    }
    ...
    public static Comment createUpdatedEntity() {
        return new Comment().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).createdAt(UPDATED_CREATED_AT);
    }
    ...
    void putExistingComment() throws Exception {
        ...
        updatedComment.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).createdAt(UPDATED_CREATED_AT);
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).createdAt(UPDATED_CREATED_AT);
